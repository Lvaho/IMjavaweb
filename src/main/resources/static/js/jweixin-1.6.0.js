!(function (e, n) {
  ...
  if (!o.jWeixin) {
    ...
    var I = !1,
      ...
      k = {}
    return (
      addEventListeners("i", "error", function (e) {
        if (!p) {
          var n = e.target,
            i = n.tagName,
            t = n.src
      ...
      //   !0
      // ),
      addEventListeners(i, "load", function (e) {
        if (!p) {
          var n = e.target,
            i = n.tagName
          n.src
    ...
    l &&
      (o.WeixinJSBridge
        ...
        : // : i.addEventListener &&
          ...
          addEventListeners(i) &&
          addEventListeners(i, "WeixinJSBridgeReady", e))
  }
})
...
function addEventListeners(ele, type, callback) {
  try {
    // Chrome、FireFox、Opera、Safari、IE9.0及以上版本
